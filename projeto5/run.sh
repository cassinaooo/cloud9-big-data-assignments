...
mvn clean package
hadoop jar target/projeto5-1.0-SNAPSHOT-fatjar.jar br.edu.ufam.willianscfa.index.Index
hadoop jar target/projeto5-1.0-SNAPSHOT-fatjar.jar br.edu.ufam.willianscfa.index.BooleanRetrieval
hadoop fs -rm -r splitted-shakespeare
