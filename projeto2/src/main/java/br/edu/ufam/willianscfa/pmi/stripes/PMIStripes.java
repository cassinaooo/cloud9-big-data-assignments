...
public class PMIStripes extends Configured implements Tool {
    ...
    public int run(String[] argv) throws Exception {
        ...
        LOG.info("Tool: " + PMIStripes.class.getSimpleName());
        ...
        wordcount_job.setJarByClass(PMIStripes.class);
        ...
        pmi_job.setJobName("PMI Stripes");
        pmi_job.setJarByClass(PMIStripes.class);
        ...
        pmi_job.setMapOutputKeyClass(Text.class);
        pmi_job.setMapOutputValueClass(HMapStFW.class);
        pmi_job.setOutputKeyClass(Text.class);
        pmi_job.setOutputValueClass(HMapStFW.class);

        pmi_job.setOutputFormatClass(TextOutputFormat.class);

        pmi_job.setMapperClass(StripesMapper.class);
        pmi_job.setReducerClass(StripesReducer.class);
